...
Scope {
    ...
    Variants {
        // The plugin's own switch decides whether this file is loaded at all;
        // this keeps the long-standing Settings -> Dock toggle working too.
        model: (Config.options?.dock.enable ?? true) ? Quickshell.screens : []
