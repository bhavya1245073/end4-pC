...
ContentPage {
    ...
    ColumnLayout {
        ...
        // Sections contributed by plugins (dock, overview, lock screen, overlay,
        // region selector, OSD, hot corners, wallpaper selector). They used to be
        // hardcoded here, which left dead controls behind whenever one was disabled.
        PluginSections {
            page: "Interface"
        }
